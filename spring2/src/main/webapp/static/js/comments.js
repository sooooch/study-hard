...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const commentModal = new bootstrap.Modal("div#commentModal", {
    backdrop: true,
  });
  ...
  function showCommentModal(event) {
    ...
    axios
      ...
      .then((response) => {
        ...
        document.querySelector("textarea#modalCommentText").value =
          response.data.ctext;
  ...
  function updateComment() {
    ...
    // Ajax요청
    axios
      .put(uri, { ctext }) // {ctext} = {ctext:ctext} 이거임
      .then((response) => {
        console.log(response);
        getAllComments(); // 댓글 목록 갱신
