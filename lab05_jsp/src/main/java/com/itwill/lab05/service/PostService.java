...
public enum PostService {
	...
	// Persistance(Repository) 계층의 기능(메서드)들을 사용하기 위해서
	private final PostDao postDao = PostDao.INSTANCE; //싱글톤에서 getInstance랑 같음
	private final UserDao userDao = UserDao.INSTANCE; //싱글톤에서 getInstance랑 같음
	...
	public int create(Post post) {
		...
		//  UserDao 메서드 호출(USERS.POINT 컬럽 업데이트)
